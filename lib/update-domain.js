...
.option('-s, --status <status>', 'Status clientHold:Account inactive:en',addStatus , addStati)
.option('--remstatus <status>', 'Status clientHold:Account inactive:en',remStatus , remStati)
