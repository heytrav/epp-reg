...
function addStati(val, stati) {
    return collectStati(val, stati);
}
function remStati(val, stati) {
...
.option('-s, --status <status>', 'Status clientHold:Account inactive:en',addStati , [])
.option('--remstatus <status>', 'Status clientHold:Account inactive:en',remStati , [])
